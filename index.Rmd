...
leaflet() %>%
  addTiles() %>%
  addMarkers(lng=33.35, lat=28.3, popup="Gulf of Suez Basin") %>%
...
leaflet() %>%
  addTiles() %>%
  addCircles(lng=33.35, lat=28.3, radius= 100000 ,color = "red" ,popup="Midetrenean Sea Basin") %>%
  addCircles(lng=-98.2, lat=22.3, radius= 100000 ,color = "red" ,popup="Tampico Misantla Basin") %>%
  addCircles(lng=-93.0, lat=18.0, radius= 100000 ,color = "red" ,popup="South Eastern Basin") %>%
  addCircles(lng=-93.2, lat=18.2, radius= 100000 ,color = "red" ,popup="South Eastern Basin") %>%
  addCircles(lng=-93.4, lat=18.4, radius= 100000 ,color = "red" ,popup="South Eastern Basin") %>%
  addCircles(lng=-93.6, lat=18.6, radius= 100000 ,color = "red" ,popup="South Eastern Basin") %>%
  ...
  addCircles(lng=43.95, lat=35.17, radius= 100000 ,color = "red" ,popup="Taxes Basin") %>%
  addCircles(lng=28.3, lat=29.8, radius= 100000 ,color = "red" ,popup="Midetrenean Sea Basin") %>%
